...
in 
{
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.vikunja.serviceConfig.ExecStart = lib.mkForce "${config.services.vikunja.package}/bin/vikunja --config ${config.sops.templates."vikunja-config.yml".path}";
